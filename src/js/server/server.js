...
server.get("/classificationfamilies/:id", (req, res) => {
  let mockData;
  try {
    mockData = require("./mock_data/classificationfamilies/classificationfamily_" +
      req.params.id);
  } catch (ex) {
...
server.get("/classifications/:id", (req, res) => {
  let mockData;
  try {
    mockData = require("./mock_data/classifications/classification_" +
      req.params.id);
  } catch (ex) {
...
server.get("/correspondencetables/:id", (req, res) => {
  ...
  let mockData;
  try {
    mockData = require("./mock_data/correspondences/correspondence_" +
      req.params.id);
  } catch (ex) {
