        ...
        <ul>
          <li>
            <a
              ...
              onClick={(ev) => this.setTextSize(ev)}
            >
              A{" "}
              <span className="screen-reader-only">
          ...
          <li>
            <a
              ...
              href="#stor-tekst"
              className="size-l"
              onClick={(ev) => this.setTextSize(ev, "large")}
            >
              A{" "}
              <span className="screen-reader-only">
          ...
          <li>
            <a
              ...
              className="size-xl"
              onClick={(ev) => this.setTextSize(ev, "extra-large")}
            >
              A
              <span className="screen-reader-only">
      ...
      <div id="main-menu" role="navigation">
        ...
        >
          ...
          <li className="top-level innrapportering" role="menuitem">
            <a
              href="https://www.ssb.no/innrapportering"
            ...
            <ul className="global-links nav">
              ...
              >
                ...
                <a
                  ...
                  onClick={(ev) => this.toggleLanguage(ev)}
                >
