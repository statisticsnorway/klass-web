...
import { Tab, TabList, TabPanel, Wrapper } from "react-aria-tabpanel"; //https://github.com/davidtheclark/react-aria-tabpanel
...
class Tabs extends Component {
		...
		if (validTo != null && moment(validTo).isBefore(new Date())) {
			return (
				<div className="version-info">
					...
					/>
					<p>
						<Translate component="span" content="TABS.VERSION_EXPIRED" />:{" "}
						<b>
		...
		if (validFrom != null && moment(validFrom).isAfter(new Date())) {
			return (
				<div className="version-info">
					...
					/>
					<p>
						<Translate component="span" content="TABS.VERSION_FUTURE" />:{" "}
						<b>
			...
			return (
				<p className="version-info">
					<Translate component="span" content="TABS.CURRENT_VERSION" />:{" "}
					<b>
						(<Translate content="TABS.VALID_FROM" />{" "}
						{moment(version.validFrom).format("MMMM YYYY")})
					</b>
	...
	render() {
		...
		if (isFetchingClass) {
			return (
				<Translate component="div" content="TABS.LOADING_CURRENT_VERSION" />
			);
			...
			<div className="tabs">
				...
				<div className="tab-content">
					<Wrapper onChange={this.onActivate.bind(this)} activeTabId={tabIndex}>
						...
						<div className="tabBody">{panels}</div>
					</Wrapper>
				</div>
			</div>
		);
