...
export function loadSubjects(params) {
	return {
		[CALL_API]: {
			...
			params: params,
			types: [
				types.SUBJECTS_REQUEST,
				types.SUBJECTS_SUCCESS,
				types.SUBJECTS_FAILURE,
			],
		},
	};
}
...
export function getClassification(id) {
	return {
		[CALL_API]: {
			...
			id: id,
			types: [
				types.SELECTED_CLASS_REQUEST,
				types.SELECTED_CLASS_SUCCESS,
				types.SELECTED_CLASS_FAILURE,
			],
		},
	};
}
...
export function loadVersion(id, languageOverride) {
	...
	return {
		[CALL_API]: {
			...
			types: [
				types.SELECTED_VERSION_REQUEST,
				types.SELECTED_VERSION_SUCCESS,
				types.SELECTED_VERSION_FAILURE,
			],
		},
	};
}
...
export function loadSSBSections() {
	return {
		[CALL_API]: {
			...
			types: [
				types.SSB_SECTION_REQUEST,
				types.SSB_SECTION_SUCCESS,
				types.SSB_SECTION_FAILURE,
			],
		},
	};
}
...
export function searchClassification(params) {
	const url = "/classifications/search";
	return {
		[CALL_API]: {
			method: "get",
			endpoint: url,
...
export function loadChanges(classificationId, params, languageOverride) {
	...
	return {
		[CALL_API]: {
			...
			language: languageOverride,
			types: [
				types.CHANGES_REQUEST,
				types.CHANGES_SUCCESS,
				types.CHANGES_FAILURE,
			],
		},
	};
}
...
export function loadCorrespondence(itemId, languageOverride) {
	const url = "/correspondencetables/" + itemId;
	return {
		[CALL_API]: {
			method: "get",
			endpoint: url,
			...
			language: languageOverride,
			types: [
				types.CORRESPONDENCE_REQUEST,
				types.CORRESPONDENCE_SUCCESS,
				types.CORRESPONDENCE_FAILURE,
			],
		},
	};
}
...
export function loadVariant(itemId, languageOverride) {
	...
	return {
		[CALL_API]: {
			...
			language: languageOverride,
			types: [
				types.VARIANT_REQUEST,
				types.VARIANT_SUCCESS,
				types.VARIANT_FAILURE,
			],
		},
	};
}
...
export function subscribe(classId, email) {
	...
	const url = "/classifications/" + classId + "/trackChanges";
	return {
		[CALL_API]: {
			method: "post",
			endpoint: url,
